...
export const LiverIcon = (props: BaseIconProps) => {
  return (
    <BaseIcon fill="#c95151" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
      width="800px" height="800px" viewBox="0 0 151.952 151.952"
      xmlSpace="preserve" {...props}>
      <motion.g>
        <motion.g>
          <motion.path fill="#c95151" d="M125.699,5.978c-14.63-12.186-24.597-2.889-29.202,2.818c-6.01,7.442-3.151,18.017,0.332,22.386
